...
import DoneIcon from "@webiny/app-headless-cms/admin/icons/done-24px.svg";
import ForwardIcon from "@webiny/app-headless-cms/admin/icons/arrow_forward-24px.svg";
